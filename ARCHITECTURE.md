...
|--------|----------|------|-------|-------------|
| Library | `content_library.yaml` | Y | Y | Content tracking |
| Schedule | `schedule.json` | Y | Y | Post scheduling |
| Drafts | `Articles/drafts/` | | Y | New articles |
...
2. Create `SKILL.md` with frontmatter and playbook structure
3. Add `automation:` level to frontmatter
4. Add `## State Dependencies` table
5. Add "Read Current State" as Step 1
6. Add "Write Updated State" as final step
7. Add `## Completion Checklist`
8. Mark `[APPROVAL GATE]` where needed
9. Add `calls:` for child skills
10. Reference in CLAUDE.md skills table
